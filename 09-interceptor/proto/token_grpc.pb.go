...
type SimpleClient interface {
	// 定义 rpc 接口，可多个
	Send(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
}
...
func (c *simpleClient) Send(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/proto.Simple/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServer interface {
	// 定义 rpc 接口，可多个
	Send(context.Context, *SimpleRequest) (*SimpleResponse, error)
...
func (UnimplementedSimpleServer) Send(context.Context, *SimpleRequest) (*SimpleResponse, error) {
...
func _Simple_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServer).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Simple/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServer).Send(ctx, req.(*SimpleRequest))
	}
...
var Simple_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Send",
			Handler:    _Simple_Send_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "09-interceptor/proto/token.proto",
}
