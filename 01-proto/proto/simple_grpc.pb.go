...
type SimpleServiceClient interface {
	SallyHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *simpleServiceClient) SallyHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/proto.SimpleService/SallyHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServiceServer interface {
	SallyHello(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedSimpleServiceServer) SallyHello(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SallyHello not implemented")
}
...
func _SimpleService_SallyHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServiceServer).SallyHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.SimpleService/SallyHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServiceServer).SallyHello(ctx, req.(*HelloRequest))
	}
...
var SimpleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SallyHello",
			Handler:    _SimpleService_SallyHello_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "01-proto/proto/simple.proto",
}
